...
function countApplesAndOranges(s, t, a, b, apples, oranges) {
    ...
    const appleFalls = apples.map(apple => {
        return a + apple
    })
    
    const orangeFalls = oranges.map(orange => {
        return b + orange
    })
    ...
    //     orangeFalls,
    // })
    const qtdAppleFallsSamHouse = appleFalls.reduce((acc, curr) => {
        if (curr >= s && curr <= t) {
            return ++acc
        }
        return acc
    ...
    const qtdOrangeFallsSamHouse = orangeFalls.reduce((acc, curr) => {
        if (curr >= s && curr <= t) {
            return ++acc
        }
        return acc
    ...
    // console.log({
    //     s, t,
    //     qtdAppleFallsSamHouse,
    //     qtdOrangeFallsSamHouse,
    // })
    
    console.log(qtdAppleFallsSamHouse)
    console.log(qtdOrangeFallsSamHouse)
}
